      ...
      >
        ...
        >
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
                <Link className="nav-link text-white active bg-gradient-primary " to="/components/smoketable">
                  <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <Link className="nav-link text-white " to="/components/flametable">
                  <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
